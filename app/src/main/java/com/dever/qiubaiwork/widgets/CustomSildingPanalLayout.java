...
public class CustomSildingPanalLayout extends SlidingPaneLayout {
    ...
    public CustomSildingPanalLayout(Context context) {
        this(context, null);
    }

    public CustomSildingPanalLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomSildingPanalLayout(Context context, AttributeSet attrs, int defStyle) {
